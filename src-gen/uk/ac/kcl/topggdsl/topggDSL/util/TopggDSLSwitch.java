 ...
 * @generated
 */
public class TopggDSLSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TopggDSLPackage.BOT:
      {
        ...
        if (result == null) result = caseEntry(bot);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TopggDSLPackage.REVIEW:
      {
        ...
        if (result == null) result = caseEntry(review);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
